...
def gen_grid(fname, lanes):
    ...
    os.system("netgenerate --tls.guess -S 20 -o {} --grid --grid.number=1  -L{} --grid.length=700 --grid.attach-length=500 --turn-lanes 1 --turn-lanes.length 150 --tls.left-green.time 30  --tls.green.time 30".format(fname, lanes))
    # max 20 m/s ~ (~ 75 km/h)
